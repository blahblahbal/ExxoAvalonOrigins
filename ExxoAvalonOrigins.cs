...
namespace ExxoAvalonOrigins
{
    class ExxoAvalonOrigins : Mod
    {
        ...
        public static ModHotKey modeChangeHotkey;
        ...
        public static readonly Version version = new Version(0, 9, 5, 0);
        ...
        UserInterface staminaInterface;
        ...
        public override void Load()
        {
            ...
            if (!Main.dedServ)
            {
                ...
                staminaBar = new StaminaBar(new Vector2(Main.screenWidth - 800, Main.screenHeight - 75));
