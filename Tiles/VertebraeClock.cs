...
{
	public class VertebraeClock : ModTile
	{
...
//			player.showItemIcon2 = ModContent.ItemType<Items.VertebraeClock>();
//		}
		...
		{
			//Item.NewItem(i * 16, j * 16, 48, 32, ModContent.ItemType<Items.VertebraeClock>());
		}
	}
}