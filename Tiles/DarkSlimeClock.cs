...
{
	public class DarkSlimeClock : ModTile
	{
		...
		public override void MouseOver(int i, int j)
		{
			...
			player.showItemIcon2 = ModContent.ItemType<Items.DarkSlimeClock>();
		}
		...
		{
			Item.NewItem(i * 16, j * 16, 48, 32, ModContent.ItemType<Items.DarkSlimeClock>());
		}
	}
}