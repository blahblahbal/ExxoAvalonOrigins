...
namespace ExxoAvalonOrigins
{
	public class MiningExplosivesBiome : MicroBiome
	{
		public override bool Place(Point origin, StructureMap structures)
		{
			...
			ushort type = Utils.SelectRandom<ushort>(GenBase._random, (ushort)((WorldGen.goldBar == 19) ? 8u : 169u), (ushort)((WorldGen.silverBar == 21) ? 9u : 168u), (ushort)((WorldGen.ironBar == 22) ? 6u : 167u), (ushort)((WorldGen.copperBar == 20) ? 7u : 166u));
