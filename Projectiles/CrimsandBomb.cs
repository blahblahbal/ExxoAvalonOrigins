...
namespace ExxoAvalonOrigins.Projectiles
{
    public class CrimsandBomb : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            if (choice == 0)
            {
                Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, -8 + Main.rand.Next(0, 17), -8 + Main.rand.Next(0, 17), ProjectileID.CrimsandBallFalling, 24, 1f, Main.myPlayer, 0f, 0f);
                Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, -8 + Main.rand.Next(0, 17), -8 + Main.rand.Next(0, 17), ProjectileID.CrimsandBallFalling, 24, 1f, Main.myPlayer, 0f, 0f);
                Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, -8 + Main.rand.Next(0, 17), -8 + Main.rand.Next(0, 17), ProjectileID.CrimsandBallFalling, 24, 1f, Main.myPlayer, 0f, 0f);
                Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, -8 + Main.rand.Next(0, 17), -8 + Main.rand.Next(0, 17), ProjectileID.CrimsandBallFalling, 24, 1f, Main.myPlayer, 0f, 0f);
                Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, -8 + Main.rand.Next(0, 17), -8 + Main.rand.Next(0, 17), ProjectileID.CrimsandBallFalling, 24, 1f, Main.myPlayer, 0f, 0f);
