...
public class DemonSpikeScale : ModProjectile
{
    ...
    public override void Kill(int timeLeft)
    {
        ...
        for (int num133 = 0; num133 < 3; num133++)
        {
            ...
            Projectile.NewProjectile(Projectile.GetItemSource_FromThis(), Projectile.position.X + num134, Projectile.position.Y + num135, num134, num135, ModContent.ProjectileType<SpikeShard>(), (int)(Projectile.damage * 0.33), 0f, Projectile.owner, 0f, 0f);
        }
    }
