        ...
        if (projectile.ai[0] == 0f)
        {
            ...
            for (var num127 = num123; num127 < num124; num127++)
            {
                ...
                while (num128 < num126)
                {
                    ...
                    if (projectile.position.X + projectile.width > vector10.X && projectile.position.X < vector10.X + 16f && projectile.position.Y + projectile.height > vector10.Y && projectile.position.Y < vector10.Y + 16f && Main.tile[num127, num128].HasUnactuatedTile && (Main.tileSolid[Main.tile[num127, num128].type] || Main.tile[num127, num128].type == 314) && (projectile.type != 403 || Main.tile[num127, num128].type == 314))
                    {
