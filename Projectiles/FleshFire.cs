...
namespace ExxoAvalonOrigins.Projectiles
{
	...
	public class FleshFireLinger : ModProjectile
	{
        ...
        public override void AI()
        {
			for (int i = 0; i < 1; i++)
			{
				int num421 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, 6, projectile.velocity.X * 0.2f, projectile.velocity.Y * 0.2f, 100, default, 3f);
