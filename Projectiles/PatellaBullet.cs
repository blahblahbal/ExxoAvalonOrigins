    ...
    public class PatellaBullet : ModProjectile
    {
        ...
        /*public override void AI()
		{
			...
			if (projectile.type == ModContent.ProjectileType<VileSpit>())
			{
				for (var j = 0; j < 2; j++)
				{
					var num19 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y + 2f), projectile.width, projectile.height, 18, projectile.velocity.X * 0.1f, projectile.velocity.Y * 0.1f, 80, default(Color), 1.3f);
			...
			if (projectile.type == ModContent.ProjectileType<KunzitePulseBolt>())
			{
				if (projectile.alpha < 170)
				{
					for (var n = 0; n < 10; n++)
					{
						...
						var num25 = Dust.NewDust(new Vector2(x, y), 1, 1, 206, 0f, 0f, 0, default(Color), 1f);
			...
			else if (projectile.type == ModContent.ProjectileType<MissileBolt>())
			{
				...
				if (projectile.ai[1] == 45f)
				{
					...
					Dust.NewDust(value - projectile.velocity, projectile.width, projectile.height, 6, projectile.direction * -0.4f, -1.4f, 0, default(Color), 1f);
					var num48 = 1.5f;
					Dust.NewDust(value - projectile.velocity, projectile.width, projectile.height, 31, projectile.direction * -0.4f, -1.4f, 0, default(Color), num48);
					Dust.NewDust(value - projectile.velocity, projectile.width, projectile.height, 6, projectile.direction * -0.4f, 1.4f, 0, default(Color), 1f);
					num48 = 1.5f;
					Dust.NewDust(value - projectile.velocity, projectile.width, projectile.height, 31, projectile.direction * -0.4f, 1.4f, 0, default(Color), num48);
				...
				else
				{
					for (var num49 = 0; num49 < 5; num49++)
					{
						...
						var num52 = 4;
						var num53 = Dust.NewDust(new Vector2(projectile.position.X + num52, projectile.position.Y + num52), projectile.width - num52 * 2, projectile.height - num52 * 2, 6, 0f, 0f, 100, default(Color), 1.2f);
					...
					{
						var num54 = 4;
						var num55 = Dust.NewDust(new Vector2(projectile.position.X + num54, projectile.position.Y + num54), projectile.width - num54 * 2, projectile.height - num54 * 2, 31, 0f, 0f, 100, default(Color), 0.6f);
