...
namespace ExxoAvalonOrigins.Projectiles
{
    public class BlahBullet : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            {
                int num202 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, DustID.Fire, 0f, 0f, 100, default(Color), 2.5f);
                Main.dust[num202].noGravity = true;
                Main.dust[num202].velocity *= 3f;
                num202 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, DustID.Fire, 0f, 0f, 100, default(Color), 1.5f);
        ...
        public override void AI()
        {
            ...
            if (projectile.alpha < 170)
            {
                for (var num26 = 0; num26 < 10; num26++)
                {
                    ...
                    int num27;
                    num27 = Dust.NewDust(new Vector2(x2, y2), 1, 1, DustID.Fire, 0f, 0f, 0, default(Color), 1f);
