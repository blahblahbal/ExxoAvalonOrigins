...
public class BlahKnife : ModProjectile
{
    ...
    public void ghostHurt(int dmg, Vector2 Position)
    {
        ...
        if (num4 != 0 || num5 != 0)
        {
            ...
            num7 *= num9;
            num8 *= num9;
            Projectile.NewProjectile(Projectile.GetProjectileSource_FromThis(), Position, new Vector2(num7, num8), ModContent.ProjectileType<BlahKnifeSplit>(), num, 0f, Projectile.owner, num2);
        }
    }
}
