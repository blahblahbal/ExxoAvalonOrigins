        ...
        public override void AI()
        {
            ...
            if (Projectile.ai[0] == 0f)
            {
                ...
                if (Projectile.type == ModContent.ProjectileType<Melee.PossessedFlamesaw>())
                {
                    ...
                    if (Projectile.type == ModContent.ProjectileType<Melee.PossessedFlamesaw>() && Main.tile[(int)(Projectile.position.X / 16f), (int)(Projectile.position.Y / 16f)].HasTile && Main.tile[(int)(Projectile.position.X / 16f), (int)(Projectile.position.Y / 16f)].TileType == 5)
                    {
