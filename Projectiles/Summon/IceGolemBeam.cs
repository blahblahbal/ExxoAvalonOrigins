...
public class IceGolemBeam : ModProjectile
{
    ...
    public override void Kill(int timeLeft)
    {
        ...
        for (int g = 0; g < 2; g++)
        {
            ...
            if (gore1 == 0) gore1 = Mod.Find<ModGore>("IcyExplosionGore1").Type;
            if (gore1 == 1) gore1 = Mod.Find<ModGore>("IcyExplosionGore2").Type;
            if (gore1 == 2) gore1 = Mod.Find<ModGore>("IcyExplosionGore3").Type;
            int gore2 = Main.rand.Next(3);
            if (gore2 == 0) gore2 = Mod.Find<ModGore>("IcyExplosionGore1").Type;
            if (gore2 == 1) gore2 = Mod.Find<ModGore>("IcyExplosionGore2").Type;
            if (gore2 == 2) gore2 = Mod.Find<ModGore>("IcyExplosionGore3").Type;
            int gore3 = Main.rand.Next(3);
            if (gore3 == 0) gore3 = Mod.Find<ModGore>("IcyExplosionGore1").Type;
            if (gore3 == 1) gore3 = Mod.Find<ModGore>("IcyExplosionGore2").Type;
            if (gore3 == 2) gore3 = Mod.Find<ModGore>("IcyExplosionGore3").Type;
