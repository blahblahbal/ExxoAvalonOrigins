...
{
    public class TroxiniumDagger : ModProjectile
    {
        ...
        {
            Rectangle dims = ExxoAvalonOrigins.GetDims("Projectiles/Summon/TroxiniumDagger");
        ...
        public override void AI()
        {
            Player player = Main.player[projectile.owner];
            ExxoAvalonOriginsModPlayer modPlayer = player.Avalon();
            Main.player[projectile.owner].AddBuff(ModContent.BuffType<Buffs.TroxiniumDagger>(), 3600);
            if (projectile.type == ModContent.ProjectileType<TroxiniumDagger>())
            {
                if (Main.player[projectile.owner].dead)
                {
                    Main.player[projectile.owner].Avalon().troxiniumDagger = false;
                }
                if (Main.player[projectile.owner].Avalon().troxiniumDagger)
                {
            ...
            else
            {
                ...
                if ((projectile.type == ModContent.ProjectileType<TroxiniumDagger>()) && projectile.ai[1] == 0f && flag31 && num768 < 500f)
                {
                    projectile.ai[1]++;
