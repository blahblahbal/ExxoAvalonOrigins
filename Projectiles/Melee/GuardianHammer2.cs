...
{
    public class GuardianHammer2 : ModProjectile
    {
        ...
        {
            Rectangle dims = ExxoAvalonOrigins.GetDims("Projectiles/Melee/GuardianHammer2");
            projectile.width = dims.Width * 28 / 68;
            projectile.height = dims.Height * 28 / 68 / Main.projFrames[projectile.type];
