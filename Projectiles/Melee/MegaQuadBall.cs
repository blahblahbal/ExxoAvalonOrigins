...
public class MegaQuadBall : ModProjectile
{
    public override void SetStaticDefaults()
    {
        DisplayName.SetDefault("MegaQuad Ball");
    }

    public override void SetDefaults()
    {
        Rectangle dims = ExxoAvalonOrigins.GetDims("Projectiles/Melee/MegaQuadBall");
    ...
    {
        var texture = ModContent.Request<Texture2D>("ExxoAvalonOrigins/Projectiles/Melee/MegaQuadBall_Chain");
