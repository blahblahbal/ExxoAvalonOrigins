...
public class PossessedFlamesaw : ModProjectile
{
    ...
    {
        Rectangle dims = ExxoAvalonOrigins.GetDims("Projectiles/Melee/PossessedFlamesaw");
    ...
    public override void AI()
    {
        ...
        if (Projectile.ai[0] == 0f)
        {
            ...
            if (Projectile.type == ModContent.ProjectileType<PossessedFlamesaw>())
            {
                ...
                if (Projectile.type == ModContent.ProjectileType<PossessedFlamesaw>() && Main.tile[(int)(Projectile.position.X / 16f), (int)(Projectile.position.Y / 16f)].HasTile && Main.tile[(int)(Projectile.position.X / 16f), (int)(Projectile.position.Y / 16f)].TileType == 5)
                {
