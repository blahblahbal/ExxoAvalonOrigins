...
namespace ExxoAvalonOrigins.Projectiles
{
    public class EbonsandBomb : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            if (choice == 0)
            {
                Projectile.NewProjectile(Projectile.Center.X, Projectile.Center.Y, -8 + Main.rand.Next(0, 17), -8 + Main.rand.Next(0, 17), ProjectileID.EbonsandBallFalling, 24, 1f, Main.myPlayer, 0f, 0f);
                Projectile.NewProjectile(Projectile.Center.X, Projectile.Center.Y, -8 + Main.rand.Next(0, 17), -8 + Main.rand.Next(0, 17), ProjectileID.EbonsandBallFalling, 24, 1f, Main.myPlayer, 0f, 0f);
                Projectile.NewProjectile(Projectile.Center.X, Projectile.Center.Y, -8 + Main.rand.Next(0, 17), -8 + Main.rand.Next(0, 17), ProjectileID.EbonsandBallFalling, 24, 1f, Main.myPlayer, 0f, 0f);
                Projectile.NewProjectile(Projectile.Center.X, Projectile.Center.Y, -8 + Main.rand.Next(0, 17), -8 + Main.rand.Next(0, 17), ProjectileID.EbonsandBallFalling, 24, 1f, Main.myPlayer, 0f, 0f);
                Projectile.NewProjectile(Projectile.Center.X, Projectile.Center.Y, -8 + Main.rand.Next(0, 17), -8 + Main.rand.Next(0, 17), ProjectileID.EbonsandBallFalling, 24, 1f, Main.myPlayer, 0f, 0f);
