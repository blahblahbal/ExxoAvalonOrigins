...
public class PearlsandBomb : ModProjectile
{
    ...
    public override void Kill(int timeLeft)
    {
        ...
        if (choice == 0)
        {
            Projectile.NewProjectile(Projectile.GetProjectileSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, -8 + Main.rand.Next(0, 17), -8 + Main.rand.Next(0, 17), ProjectileID.PearlSandBallFalling, 24, 1f, Main.myPlayer, 0f, 0f);
            Projectile.NewProjectile(Projectile.GetProjectileSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, -8 + Main.rand.Next(0, 17), -8 + Main.rand.Next(0, 17), ProjectileID.PearlSandBallFalling, 24, 1f, Main.myPlayer, 0f, 0f);
            Projectile.NewProjectile(Projectile.GetProjectileSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, -8 + Main.rand.Next(0, 17), -8 + Main.rand.Next(0, 17), ProjectileID.PearlSandBallFalling, 24, 1f, Main.myPlayer, 0f, 0f);
            Projectile.NewProjectile(Projectile.GetProjectileSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, -8 + Main.rand.Next(0, 17), -8 + Main.rand.Next(0, 17), ProjectileID.PearlSandBallFalling, 24, 1f, Main.myPlayer, 0f, 0f);
            Projectile.NewProjectile(Projectile.GetProjectileSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, -8 + Main.rand.Next(0, 17), -8 + Main.rand.Next(0, 17), ProjectileID.PearlSandBallFalling, 24, 1f, Main.myPlayer, 0f, 0f);
