    ...
    internal class PyrasiteHead : PyrasiteWorm
    {
        ...
        public override float SpawnChance(NPCSpawnInfo spawnInfo)
        {
            if (spawnInfo.player.GetModPlayer<ExxoAvalonOriginsModPlayer>().zoneBooger && !spawnInfo.player.GetModPlayer<ExxoAvalonOriginsModPlayer>().InPillarZone() && spawnInfo.player.ZoneOverworldHeight)
                return (spawnInfo.player.GetModPlayer<ExxoAvalonOriginsModPlayer>().zoneBooger && !spawnInfo.player.GetModPlayer<ExxoAvalonOriginsModPlayer>().InPillarZone() && spawnInfo.player.ZoneOverworldHeight) ? 0.5f : 0f;
            return 0f;
        }
