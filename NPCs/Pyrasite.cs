...
namespace ExxoAvalonOrigins.NPCs
{
    internal class PyrasiteHead : PyrasiteWorm
    {
        ...
        {
            if (spawnInfo.player.GetModPlayer<ExxoAvalonOriginsModPlayer>().ZoneBooger && !spawnInfo.player.InPillarZone() && spawnInfo.player.ZoneOverworldHeight)
                return (spawnInfo.player.GetModPlayer<ExxoAvalonOriginsModPlayer>().ZoneBooger && !spawnInfo.player.InPillarZone() && spawnInfo.player.ZoneOverworldHeight) ? 0.5f : 0f;
            return 0f;
        }
