...
namespace ExxoAvalonOrigins.NPCs
{
	public class Ickslime : ModNPC
	{
        ...
        {
            if (spawnInfo.player.GetModPlayer<ExxoAvalonOriginsModPlayer>().ZoneBooger && !spawnInfo.player.InPillarZone() && Main.hardMode)
                return (spawnInfo.player.GetModPlayer<ExxoAvalonOriginsModPlayer>().ZoneBooger && !spawnInfo.player.InPillarZone() && Main.hardMode) ? 0.7f : 0f;
            return 0f;
        }
