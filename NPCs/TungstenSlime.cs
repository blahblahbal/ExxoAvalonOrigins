...
namespace ExxoAvalonOrigins.NPCs
{
    public class TungstenSlime : ModNPC
    {
        ...
        {
            return spawnInfo.player.ZoneRockLayerHeight && !spawnInfo.player.ZoneDungeon && (Main.hardMode || WorldGen.SilverTierOre == TileID.Tungsten) ? 0.00526f * ExxoAvalonOriginsGlobalNPC.endoSpawnRate : 0f;
        }
    }
}
