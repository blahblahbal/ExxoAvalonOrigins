...
public class TungstenSlime : ModNPC
{
    ...
    {
        return spawnInfo.player.ZoneRockLayerHeight && !spawnInfo.player.ZoneDungeon && (Main.hardMode || WorldGen.SavedOreTiers.Silver == TileID.Tungsten) ? 0.00526f * ExxoAvalonOriginsGlobalNPC.endoSpawnRate : 0f;
    }
}