...
namespace ExxoAvalonOrigins.NPCs
{
	public class TungstenSlime : ModNPC
	{
        ...
        {
            return spawnInfo.player.ZoneRockLayerHeight && !spawnInfo.player.ZoneDungeon && (Main.hardMode || WorldGen.SilverTierOre == TileID.Tungsten) ? 0.0526f * ExxoAvalonOriginsGlobalNPC.endoSpawnRate : 0f;
        }
    }
}