...
namespace ExxoAvalonOrigins.NPCs
{
	public class IronSlime : ModNPC
	{
        ...
        {
            return spawnInfo.player.ZoneRockLayerHeight && !spawnInfo.player.ZoneDungeon && (Main.hardMode || WorldGen.IronTierOre == TileID.Iron) ? 0.0526f * ExxoAvalonOriginsGlobalNPC.endoSpawnRate : 0f;
        }
    }
}