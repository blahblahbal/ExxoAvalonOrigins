...
namespace ExxoAvalonOrigins.NPCs
{
	public class CopperSlime : ModNPC
	{
        ...
        {
            return spawnInfo.player.ZoneRockLayerHeight && !spawnInfo.player.ZoneDungeon && (Main.hardMode || WorldGen.CopperTierOre == TileID.Copper) ? 0.0526f * ExxoAvalonOriginsGlobalNPC.endoSpawnRate : 0f;
        }
    }
}