...
namespace ExxoAvalonOrigins.Logic
{
    public static class RecipeCreator
    {
        public static void CreateRecipes(Mod mod)
        {
            ...
            recipe.AddIngredient(ModContent.ItemType<Pathogen>());
            recipe.SetResult(ModContent.ItemType<PathogenTorch>(), 33);
            recipe.AddRecipe();
            ...
            recipe = new ModRecipe(mod);
            recipe.AddIngredient(ModContent.ItemType<HallowedOre>(), 5);
            ...
            recipe.SetResult(ModContent.ItemType<JungleTorch>(), 10);
            recipe.AddRecipe();

            recipe = new ModRecipe(mod);
            recipe.AddIngredient(ItemID.Torch, 3);
            recipe.AddIngredient(ModContent.ItemType<Tourmaline>());
            recipe.SetResult(ModContent.ItemType<CyanTorch>(), 3);
            recipe.AddRecipe();

            recipe = new ModRecipe(mod);
            recipe.AddIngredient(ItemID.Torch, 3);
            recipe.AddIngredient(ModContent.ItemType<Peridot>());
            recipe.SetResult(ModContent.ItemType<LimeTorch>(), 3);
            recipe.AddRecipe();

            recipe = new ModRecipe(mod);
            recipe.AddIngredient(ItemID.Torch, 3);
            recipe.AddIngredient(ModContent.ItemType<Zircon>());
            recipe.SetResult(ModContent.ItemType<BrownTorch>(), 3);
            recipe.AddRecipe();

            recipe = new ModRecipe(mod);
            recipe.AddIngredient(ItemID.Bottle);
            recipe.AddIngredient(ItemID.Obsidian);
            recipe.SetResult(ModContent.ItemType<BottledLava>());
            recipe.AddRecipe();
            ...
            recipe.AddTile(TileID.Bottles);
            recipe.SetResult(ModContent.ItemType<TimeShiftPotion>(), 5);
            recipe.AddRecipe();

            recipe = new ModRecipe(mod);
            recipe.AddIngredient(ItemID.BottledWater, 5);
            recipe.AddIngredient(ModContent.ItemType<ChaosDust>(), 9);
            recipe.AddIngredient(ItemID.Waterleaf, 3);
            recipe.AddIngredient(ItemID.Fireblossom, 3);
            recipe.AddTile(TileID.Bottles);
            recipe.SetResult(ModContent.ItemType<ShadowPotion>(), 5);
            recipe.AddRecipe();
            ...
            recipe.AddTile(TileID.Bottles);
            recipe.SetResult(ModContent.ItemType<TitanskinPotion>());
            recipe.AddRecipe();
            ...
            recipe = new ModRecipe(mod);
            recipe.AddIngredient(ItemID.BottledWater);
            recipe.AddIngredient(ModContent.ItemType<Beak>());
            recipe.AddIngredient(ItemID.IronOre);
            recipe.AddIngredient(ModContent.ItemType<RottenEye>());
            recipe.AddTile(TileID.Bottles);
            recipe.SetResult(ModContent.ItemType<GPSPotion>());
            recipe.AddRecipe();
            ...
            recipe.AddIngredient(ModContent.ItemType<Beak>());
            recipe.AddIngredient(ItemID.IronOre);
            recipe.AddIngredient(ModContent.ItemType<Patella>());
            recipe.AddTile(TileID.Bottles);
            recipe.SetResult(ModContent.ItemType<GPSPotion>());
            recipe.AddRecipe();
            ...
            recipe.AddTile(TileID.Bottles);
            recipe.SetResult(ModContent.ItemType<StrengthPotion>());
            recipe.AddRecipe();
            ...
            recipe.AddTile(TileID.Bottles);
            recipe.SetResult(ModContent.ItemType<BloodCastPotion>(), 6);
            recipe.AddRecipe();
            ...
            recipe.AddTile(TileID.Bottles);
            recipe.SetResult(ModContent.ItemType<CrimsonPotion>());
            recipe.AddRecipe();
            ...
            recipe.AddIngredient(ItemID.Blinkroot);
            recipe.AddTile(TileID.Bottles);
            recipe.SetResult(ModContent.ItemType<ShockwavePotion>());
            recipe.AddRecipe();
            ...
            recipe.AddTile(TileID.Bottles);
            recipe.SetResult(ModContent.ItemType<ElixirofLife>());
            recipe.AddRecipe();
            ...
            recipe.AddIngredient(ItemID.SpecularFish);
            recipe.AddTile(TileID.Bottles);
            recipe.SetResult(ModContent.ItemType<RoguePotion>());
            recipe.AddRecipe();
            ...
            recipe.AddTile(TileID.Bottles);
            recipe.SetResult(ModContent.ItemType<WisdomPotion>());
            recipe.AddRecipe();
            ...
            recipe.AddTile(TileID.Bottles);
            recipe.SetResult(ModContent.ItemType<GauntletPotion>());
            recipe.AddRecipe();
            ...
            recipe.AddIngredient(ItemID.Meteorite);
            recipe.AddTile(TileID.Bottles);
            recipe.SetResult(ModContent.ItemType<StarbrightPotion>());
            recipe.AddRecipe();

            recipe = new ModRecipe(mod);
            recipe.AddIngredient(ItemID.BottledWater);
            recipe.AddIngredient(ModContent.ItemType<Pathogen>(), 5);
            recipe.AddTile(TileID.ImbuingStation);
            recipe.SetResult(ModContent.ItemType<FlaskofInfection>());
            recipe.AddRecipe();
            ...
            recipe.AddIngredient(ModContent.ItemType<Pathogen>());
            recipe.AddTile(TileID.MythrilAnvil);
            recipe.SetResult(ModContent.ItemType<PathogenArrow>(), 35);
            recipe.AddRecipe();

            recipe = new ModRecipe(mod);
            recipe.AddIngredient(ItemID.TungstenBar, 2);
            recipe.AddTile(TileID.Anvils);
            recipe.SetResult(ModContent.ItemType<TungstenBullet>(), 35);
            recipe.AddRecipe();

            recipe = new ModRecipe(mod);
            recipe.AddIngredient(ModContent.ItemType<FrostShard>());
            recipe.AddTile(TileID.Anvils);
            recipe.SetResult(ModContent.ItemType<Icicle>(), 10);
            recipe.AddRecipe();
            ...
            recipe.AddTile(TileID.MythrilAnvil);
            recipe.SetResult(ModContent.ItemType<CrystalSeed>(), 50);
            recipe.AddRecipe();
            ...
            recipe.AddTile(TileID.MythrilAnvil);
            recipe.SetResult(ModContent.ItemType<CursedTooth>(), 50);
            recipe.AddRecipe();

            recipe = new ModRecipe(mod);
            recipe.AddIngredient(ItemID.MusketBall, 25);
            recipe.AddIngredient(ModContent.ItemType<RottenEye>(), 5);
            recipe.AddIngredient(ItemID.CursedFlame);
            recipe.AddTile(TileID.MythrilAnvil);
            recipe.SetResult(ModContent.ItemType<RottenBullet>(), 25);
            recipe.AddRecipe();

            recipe = new ModRecipe(mod);
            recipe.AddIngredient(ItemID.MusketBall, 25);
            recipe.AddIngredient(ModContent.ItemType<Patella>(), 5);
            recipe.AddIngredient(ItemID.Ichor);
            recipe.AddTile(TileID.MythrilAnvil);
            recipe.SetResult(ModContent.ItemType<PatellaBullet>(), 25);
            recipe.AddRecipe();
            ...
            recipe.AddIngredient(ModContent.ItemType<Pathogen>());
            recipe.AddTile(TileID.MythrilAnvil);
            recipe.SetResult(ModContent.ItemType<PathogenBullet>(), 60);
            recipe.AddRecipe();

            recipe = new ModRecipe(mod);
            recipe.AddIngredient(ModContent.ItemType<Coughwood>());
            recipe.SetResult(ModContent.ItemType<CoughwoodPlatform>(), 2);
            recipe.AddRecipe();
            ...
            recipe.SetResult(ModContent.ItemType<OpalGemsparkBlock>(), 20);
            recipe.AddRecipe();
            ...
            recipe.AddTile(TileID.WorkBenches);
            recipe.SetResult(ModContent.ItemType<MintChocolateCandyCaneBlock>(), 2);
            recipe.AddRecipe();
            ...
            recipe.AddIngredient(ModContent.ItemType<ChocolateCandyCaneBlock>());
            recipe.AddTile(TileID.WorkBenches);
            recipe.SetResult(ModContent.ItemType<RedVelvetCandyCaneBlock>(), 2);
            recipe.AddRecipe();
            ...
            recipe.AddIngredient(ModContent.ItemType<ChocolateCandyCaneBlock>());
            recipe.AddTile(TileID.WorkBenches);
            recipe.SetResult(ModContent.ItemType<RainbowCandyCaneBlock>(), 3);
            recipe.AddRecipe();

            recipe = new ModRecipe(mod);
            recipe.AddIngredient(ModContent.ItemType<MintChocolateCandyCaneBlock>());
            recipe.AddTile(TileID.WorkBenches);
            recipe.SetResult(ModContent.ItemType<MintChocolateCandyCaneWall>(), 4);
            recipe.AddRecipe();

            recipe = new ModRecipe(mod);
            recipe.AddIngredient(ModContent.ItemType<RedVelvetCandyCaneBlock>());
            recipe.AddTile(TileID.WorkBenches);
            recipe.SetResult(ModContent.ItemType<RedVelvetCandyCaneWall>(), 4);
            recipe.AddRecipe();

            recipe = new ModRecipe(mod);
            recipe.AddIngredient(ModContent.ItemType<RainbowCandyCaneBlock>());
            recipe.AddTile(TileID.WorkBenches);
            recipe.SetResult(ModContent.ItemType<RainbowCandyCaneWall>(), 4);
            recipe.AddRecipe();

            recipe = new ModRecipe(mod);
            recipe.AddIngredient(ModContent.ItemType<FeroziumBrick>());
            recipe.AddTile(TileID.WorkBenches);
            recipe.SetResult(ModContent.ItemType<FeroziumBrickWall>(), 4);
            recipe.AddRecipe();

            recipe = new ModRecipe(mod);
            recipe.AddIngredient(ModContent.ItemType<ImperviousBrick>());
            recipe.AddTile(TileID.WorkBenches);
            recipe.SetResult(ModContent.ItemType<ImperviousBrickWall>(), 4);
            recipe.AddRecipe();

            recipe = new ModRecipe(mod);
            recipe.AddIngredient(ModContent.ItemType<PyroscoricBrick>());
            recipe.AddTile(TileID.WorkBenches);
            recipe.SetResult(ModContent.ItemType<PyroscoricBrickWall>(), 4);
            recipe.AddRecipe();
            ...
            recipe.SetResult(ModContent.ItemType<FeroziumBrick>());
            recipe.AddRecipe();

            recipe = new ModRecipe(mod);
            recipe.AddIngredient(ModContent.ItemType<LeadBrick>());
            recipe.AddTile(TileID.WorkBenches);
            recipe.SetResult(ModContent.ItemType<LeadBrickWall>(), 4);
            recipe.AddRecipe();

            recipe = new ModRecipe(mod);
            recipe.AddIngredient(ModContent.ItemType<IronBrick>());
            recipe.AddTile(TileID.WorkBenches);
            recipe.SetResult(ModContent.ItemType<IronBrickWall>(), 4);
            recipe.AddRecipe();
            ...
            recipe.AddTile(TileID.Furnaces);
            recipe.SetResult(ModContent.ItemType<LeadBrick>());
            recipe.AddRecipe();
            ...
            recipe.AddIngredient(ItemID.StoneBlock);
            recipe.AddTile(TileID.Furnaces);
            recipe.SetResult(ModContent.ItemType<IronBrick>());
            recipe.AddRecipe();
            ...
            recipe.AddIngredient(ItemID.StoneBlock);
            recipe.AddTile(TileID.Furnaces);
            recipe.SetResult(ModContent.ItemType<RhodiumBrick>());
            recipe.AddRecipe();
            ...
            recipe.AddIngredient(ItemID.StoneBlock);
            recipe.AddTile(TileID.Furnaces);
            recipe.SetResult(ModContent.ItemType<DurataniumBrick>());
            recipe.AddRecipe();
            ...
            recipe.AddIngredient(ItemID.StoneBlock);
            recipe.AddTile(TileID.Furnaces);
            recipe.SetResult(ModContent.ItemType<NaquadahBrick>());
            recipe.AddRecipe();
            ...
            recipe.AddIngredient(ItemID.StoneBlock);
            recipe.AddTile(TileID.Furnaces);
            recipe.SetResult(ModContent.ItemType<TroxiniumBrick>());
            recipe.AddRecipe();

            recipe = new ModRecipe(mod);
            recipe.AddIngredient(ModContent.ItemType<RhodiumBrick>());
            recipe.AddTile(TileID.WorkBenches);
            recipe.SetResult(ModContent.ItemType<RhodiumBrickWall>(), 4);
            recipe.AddRecipe();

            recipe = new ModRecipe(mod);
            recipe.AddIngredient(ModContent.ItemType<DurataniumBrick>());
            recipe.AddTile(TileID.WorkBenches);
            recipe.SetResult(ModContent.ItemType<DurataniumBrickWall>(), 4);
            recipe.AddRecipe();

            recipe = new ModRecipe(mod);
            recipe.AddIngredient(ModContent.ItemType<NaquadahBrick>());
            recipe.AddTile(TileID.WorkBenches);
            recipe.SetResult(ModContent.ItemType<NaquadahBrickWall>(), 4);
            recipe.AddRecipe();

            recipe = new ModRecipe(mod);
            recipe.AddIngredient(ModContent.ItemType<TroxiniumBrick>());
            recipe.AddTile(TileID.WorkBenches);
            recipe.SetResult(ModContent.ItemType<TroxiniumBrickWall>(), 4);
            recipe.AddRecipe();
            ...
            recipe.AddIngredient(ItemID.StoneBlock);
            recipe.AddTile(TileID.Furnaces);
            recipe.SetResult(ModContent.ItemType<OsmiumBrick>());
            recipe.AddRecipe();

            recipe = new ModRecipe(mod);
            recipe.AddIngredient(ModContent.ItemType<OsmiumBrickWall>(), 4);
            recipe.AddTile(TileID.WorkBenches);
            recipe.SetResult(ModContent.ItemType<OsmiumBrick>());
            recipe.AddRecipe();

            recipe = new ModRecipe(mod);
            recipe.AddIngredient(ModContent.ItemType<OsmiumBrick>());
            recipe.AddTile(TileID.WorkBenches);
            recipe.SetResult(ModContent.ItemType<OsmiumBrickWall>(), 4);
            recipe.AddRecipe();

            recipe = new ModRecipe(mod);
            recipe.AddIngredient(ItemID.Vertebrae);
            recipe.AddTile(TileID.WorkBenches);
            recipe.SetResult(ModContent.ItemType<VertebraeWall>(), 4);
            recipe.AddRecipe();
            ...
            recipe = new ModRecipe(mod);
            recipe.AddIngredient(ModContent.ItemType<BlueLihzahrdBrick>());
            recipe.AddTile(TileID.WorkBenches);
            recipe.SetResult(ModContent.ItemType<BlueLihzahrdBrickWall>(), 4);
            recipe.AddRecipe();

            recipe = new ModRecipe(mod);
            recipe.AddIngredient(ItemID.Obsidian);
            recipe.AddTile(TileID.WorkBenches);
            recipe.SetResult(ModContent.ItemType<ObsidianLavaTubeWall>(), 4);
            recipe.AddRecipe();
            ...
            recipe.AddIngredient(ItemID.StoneBlock);
            recipe.AddTile(TileID.Furnaces);
            recipe.SetResult(ModContent.ItemType<HeartstoneBrick>());
            recipe.AddRecipe();
            ...
            recipe = new ModRecipe(mod);
            recipe.AddIngredient(ModContent.ItemType<OrangeBrickWall>(), 4);
            recipe.AddTile(TileID.WorkBenches);
            recipe.SetResult(ModContent.ItemType<OrangeBrick>());
            recipe.AddRecipe();

            recipe = new ModRecipe(mod);
            recipe.AddIngredient(ModContent.ItemType<OrangeSlabWall>(), 4);
            recipe.AddTile(TileID.WorkBenches);
            recipe.SetResult(ModContent.ItemType<OrangeBrick>());
            recipe.AddRecipe();

            recipe = new ModRecipe(mod);
            recipe.AddIngredient(ModContent.ItemType<OrangeTiledWall>(), 4);
            recipe.AddTile(TileID.WorkBenches);
            recipe.SetResult(ModContent.ItemType<OrangeBrick>());
            recipe.AddRecipe();
            ...
            recipe.AddTile(TileID.Furnaces);
            recipe.SetResult(ModContent.ItemType<SporeBlock>());
            recipe.AddRecipe();
            ...
            recipe.SetResult(ModContent.ItemType<GemWand>());
            recipe.AddRecipe();
